		...
		<header id="header" class="fullwidth">
            <section id="logo" class="left">
               ...
               <!-- <li class="<?php echo menu_active( 'settings' );?>"><a href="/index.php/settings/"><i class="icon-equalizer"></i><?php _e( 'Settings' );?></a></li>-->
                ...
                <li class="<?php echo menu_active( 'addons' );?>"><a href="/index.php/addons/"><i class="icon-puzzle3"></i><?php _e( 'Addons' );?></a></li>
                <li class="<?php echo menu_active( 'docker' );?>"><a href="/index.php/docker/"><i class="icon-docker-plain"></i><?php _e( 'Docker' );?></a></li>
